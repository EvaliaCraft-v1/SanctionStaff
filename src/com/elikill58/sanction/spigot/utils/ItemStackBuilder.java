...
public class ItemStackBuilder implements Listener {
	...
	/**
	 * Définit le nom de l'ItemStack qui sera affiché en jeu. Il sera également
	 * utilisé lors du processing des events.
	 *
	 * @param displayName le nom de l'ItemStack qui sera affiché en jeu. La valeur
	 *                    null reset le displayName.
	 *
	 * @return ce builder
	 */
	...
	/**
	 * Réinitialise le nom de l'ItemStack. Équivaut à {@code #displayName(null)}
	 *
	 * @return ce builder
	 */
	...
	/**
	 * Indique si oui ou non l'ItemStack est indestructible. Il est souvent plus
	 * pratique d'utiliser {@link #unbreakable()}
	 *
	 *
	...
	/**
	 * Définit l'ItemStack comme indestructible. Équivalent à
	 * {@code #unbreakable(true)}.
	 *
	 * @return ce builder
	 */
	...
	public ItemStackBuilder lore(String... lore) {
		if (lore == null || (lore.length == 1 && (lore[0] == "" || lore[0] == null)))
			return this;
	...
	public ItemStackBuilder lore(List<String> lore) {
		if (lore == null || lore.isEmpty() || (lore.size() == 1 && (lore.get(0) == "" || lore.get(0) == null)))
			return this;
		List<String> list = this.itemMeta.hasLore() ? this.itemMeta.getLore() : new ArrayList<>();
		for (String s : lore)
			if (s != null)
